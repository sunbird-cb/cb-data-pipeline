package org.sunbird.cb.preprocessor.util
...
class TelemetryValidator(config: CBPreprocessorConfig) extends java.io.Serializable {

  private val serialVersionUID = - 2903685244618349849L
